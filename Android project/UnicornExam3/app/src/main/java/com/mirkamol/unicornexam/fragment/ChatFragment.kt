...
class ChatFragment : Fragment() {
    ...
    private fun refreshAdapter(items: ArrayList<MessageItem>) {
        recyclerView.adapter = MessageItemAdapter(requireContext(), items)
    }

    private fun getAllMessages(): ArrayList<MessageItem> {
        val items: ArrayList<MessageItem> = ArrayList()
