...
class TelegramAnimationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val animationJson = listOf<String>("telegram_icon.json", "speedometer.json", "pink_gift.json", "infinity.json","secure_lock.json", "clouds.json")

        tv_text = findViewById(R.id.tv_text)
        txtPageListener=findViewById(R.id.pageNumber)

        val adapter = Adapter(animationJson, this)
